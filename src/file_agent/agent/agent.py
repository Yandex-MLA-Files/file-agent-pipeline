...
def build_system_prompt(
    ...
    return (
        ...
        "7. When a question is about a chart, diagram, photo or anything the text "
        "around a figure does not spell out, and inspect_image is available, list the "
        "document's images with it and then ask it a specific question about the right "
        "one.\n"
        "8. If an attempt finds nothing, try once or twice more with different words or "
        ...
        "contain.\n"
        "9. Never repeat a call you already made with the same arguments.\n\n"
